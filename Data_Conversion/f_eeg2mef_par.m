function [] = f_eeg2mef_par(animalDir, dataBlockLen, gapThresh, mefBlockSize)
...
%       varargin = optional argument, set to 1 to run in parallel
%
%   OUTPUT:
...
%       end
    ...
    % dichter data set
    parfor c = 1: animalNChan  % 1-4 are CA1 and DG, except r151 and r152
      ...
      h = getMefWriter(mefFile, mefBlockSize, animalSF, gapThresh); 
